    ...
    <section id="booking" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Ready to get started? Contact us for a personalized quote</p>
        </div>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="text-center">
              <p className="text-gray-600 mb-6">
                Get an instant quote by chatting with us about your needs. Fast, easy, and personalized.
              </p>
              <Button className="bg-red-600 hover:bg-red-700 text-white w-full">Start Chat</Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <p className="text-sm text-gray-500 mt-4 text-center">
                * We'll follow up to confirm details and send a quote within 24 hours.
              </p>
            </CardContent>
          </Card>
        </div>
